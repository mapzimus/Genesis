...
Acquire the operator run lock. Read `AGENTS.md`, `PREREGISTRATION.md`, `GENESIS_CHARTER.md`, `STATE.json`, `TOOL_MANIFEST.md`, the treasury, pending approvals/actions, and unresolved incidents.
